        ...
        <div class='privacy-container'>
            ...
            <div class='content-section'>
                <p class='content-text'>
                    At TileVerse, accessible from https://explora-y-juega.com/, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that are collected and recorded by TileVerse and how we use it.
                </p>
                <p class='content-text'>
            ...
            <div class='content-section'>
                <h2 class='content-title'>Log Files</h2>
                <p class='content-text'>
                    TileVerse follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and are a part of hosting services' analytics. The information collected by log files includes internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any personally identifiable information. The purpose of the information is to analyze trends, administer the site, track users' movement on the website, and gather demographic information.
                </p>
            </div>

            <div class='content-section'>
                <h2 class='content-title'>Cookies and Web Beacons</h2>
                <p class='content-text'>
                    Like any other website, TileVerse uses "cookies." These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.
                </p>
            </div>
            <div class='content-section'>
                <h2 class='content-title'>Google DoubleClick DART Cookie</h2>
                <p class='content-text'>
                    Google is one of the third-party vendors on our site. It also uses cookies, known as DART cookies, to serve ads to our site visitors based upon their visit to https://explora-y-juega.com/ and other sites on the internet. However, visitors may choose to decline the use of DART cookies by visiting the Google ad and content network Privacy Policy at <a href='https://policies.google.com/technologies/ads' class='link'>https://policies.google.com/technologies/ads</a>
                </p>
            </div>

            <div class='content-section'>
                <h2 class='content-title'>Our Advertising Partners</h2>
                <p class='content-text'>
                    Some advertisers on our site may use cookies and web beacons. Our advertising partners are listed below. Each of our advertising partners has its own Privacy Policy for their policies on user data.
                </p>
                <p class='content-text'>
                    Google - <a href='https://policies.google.com/technologies/ads' class='link'>https://policies.google.com/technologies/ads</a>
                </p>
            </div>

            <div class='content-section'>
                <h2 class='content-title'>Third-Party Privacy Policies</h2>
                <p class='content-text'>
                    TileVerse's Privacy Policy does not apply to other advertisers or websites. Thus, we advise you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt out of certain options.
                </p>
                <p class='content-text'>
                    You can choose to disable cookies through your browser settings. More detailed information about cookie management with specific web browsers can be found at the browsers' respective websites.
                </p>
            </div>

            <div class='content-section'>
                <h2 class='content-title'>Children's Information</h2>
                <p class='content-text'>
                    Another part of our priority is adding protection for children while using the internet. We encourage parents and guardians to observe, participate in, and/or monitor and guide their online activity.
                </p>
                <p class='content-text'>
                    TileVerse does not knowingly collect any personally identifiable information from children under the age of 13. If you believe that your child provided this kind of information on our website, we strongly encourage you to contact us immediately, and we will do our best to promptly remove such information from our records.
                </p>
            </div>

            <div class='content-section'>
                <h2 class='content-title'>Online Privacy Policy Only</h2>
                <p class='content-text'>
                    This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they share and/or collect on TileVerse. This policy does not apply to any information collected offline or via channels other than this website.
                </p>
            </div>
        </div>
    </section>
